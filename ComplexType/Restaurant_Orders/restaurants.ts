...
export type Restuanrant = typeof restaurants[0];
// {name: string, priceBracket: PriceBracket, delivertyTimeMinutes: number, openHour: string, closeHour: string, distance: string}